...
<h4 class="card-title">Update Purchase Form</h4>
    ...
    <tr style="text-align:center;">
      ...
      <td>
        <div class="input-group icon_tag_input abc">
          <input id="price_id_0" name="price[]" readonly value="0.00" class="form-control align-right " type="number">
          <span class="purchase_tk_mark">৳</span>
        </div>
      </td>
      <td>
        <div class="input-group icon_tag_input abc">
          <input id="product_price_qty_0" readonly value="0.00" class="form-control align-right subtotal" type="number">
          <span class="purchase_tk_mark">৳</span>
        </div>
      </td>
      <td>
        <a class=" btn btn-success btn-xs" id="row_div">
