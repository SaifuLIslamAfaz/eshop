...
<h4 class="card-title">Add Ads Form</h4>
...
<div class="card-body">
<form action="admin/add_ads_post" enctype="multipart/form-data" method="post" class="form form-horizontal striped-rows"  autocomplete="off" >
<div class="form-body">
<div class="form-group row">
    <label class="col-md-3 label-control" for="eventRegInput2">Advertise-Positions</label>
    <div class="col-md-8">
        <select class="select2 form-control" id="id_h5_single" name="ads_position">
...
<div class="form-group row">
    ...
    <div class="col-md-8">
        <input type="text" id="eventRegInput1" class="form-control" placeholder="Ads Name" name="ads_name">
    </div>
</div>
<div class="form-group row">
