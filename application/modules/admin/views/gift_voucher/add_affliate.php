...
<h4 class="card-title">Add Affliate</h4>
...
<div class="card-body">
<form action="admin/add_affliate_post" enctype="multipart/form-data" method="post" class="form form-horizontal striped-rows">
<div class="form-body">
    
<div class="form-group row">
    <label class="col-md-3 label-control" for="eventRegInput1">Affliate Link Name</label>
    <div class="col-md-8">
        <input type="text" id="eventRegInput1" class="form-control" placeholder="Enter Affliate Link Name" name="gift_name">
    </div>
</div>
<div class="form-group row">
    <label class="col-md-3 label-control" for="eventRegInput1">Affliate  Amnt</label>
    <div class="col-md-8">
        <input type="text" id="eventRegInput1" class="form-control" placeholder="Enter Affliate  Amn" name="gift_price">
    </div>
</div>
<div class="form-group row">
