            ...
            <div class="col-10 offset-1">
              <div class="card">
                <div class="card-header bg_color">
                  <h4 class="card-title">Update Affliate Link</h4>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-content collpase show">
                        <div class="card-body">
                          <form action="admin/update_affliate_post/<?=$voucher_data[0]['id']; ?>" enctype="multipart/form-data" method="post" class="form form-horizontal striped-rows">
                            <div class="form-body">
                              ...
                              <div class="form-group row">
                                <label class="col-md-3 label-control" for="eventRegInput1">  Affliate Price</label>
                                <div class="col-md-8">
