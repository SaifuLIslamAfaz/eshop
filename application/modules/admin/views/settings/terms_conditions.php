...
<div class="card-body">
<form action="admin/update_terms_conditions_post/<?=$terms_data[0]['id'];?> enctype="multipart/form-data" method="post" class="form form-horizontal striped-rows"  autocomplete="off" >
<div class="form-body">
<div class="form-group row">
    ...
    <div class="col-md-8">
         ...
         <textarea name="terms_conditions" class="span3 " id="editor"  required>
         <?=$terms_data[0]['terms_conditions'];?>
