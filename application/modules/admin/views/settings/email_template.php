 ...
 <th>Message</th>
                ...
                foreach ($email_template as $key => $value) 
                {
                    ...
                    echo "<tr>
                              ...
                              <td>$email_subject</td>
                            <td>$email_body</td>
                              <td class='d-flex'> <a href='admin/delete_email_template/$ssl_id' class='type-error   btn btn-icon btn-danger btn_delete mr-1 mb-1 mt-1'>
                                  <i class='fa fa-trash'>
                                 Delete
                                 </i>
                                  </a>
                                  <a href='admin/edit_email_template/$ssl_id' class='btn btn-icon btn_edit icon mr-1 mb-1 mt-1'>
                                  
                                 Edit
                                 
                                  </a>
<a href='admin/update_email_template/$ssl_id/$ac_st' class='type-error   btn btn-icon  btn_inactive_userlist mr-1 mb-1 mt-1'>
