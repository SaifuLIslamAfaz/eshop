...
<h4 class="card-title">Set SMS Gateway</h4>
 ...
 <th>URL</th>
                ...
                foreach ($sms_gateway as $key => $value) 
                {
                    ...
                    echo "<tr>
                              ...
                              <td>$sms_key</td>
                             <td>$api_url</td>
                              <td class='d-flex'> <a href='admin/delete_sms_gateway/$ssl_id' class='type-error   btn btn-icon btn-danger btn_delete mr-1 mb-1 mt-1'>
                                  <i class='fa fa-trash'>
                                 Delete
                                 </i>
                                  </a>
                                  <a href='admin/edit_sms_gateway/$ssl_id' class='btn btn-icon btn_edit icon mr-1 mb-1 mt-1'>
                                  
                                 Edit
                                 
                                  </a>
                                    <a href='admin/update_sms_gateway/$ssl_id/$ac_st' class='type-error   btn btn-icon  btn_inactive_userlist mr-1 mb-1 mt-1'>
