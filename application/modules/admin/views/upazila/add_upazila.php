        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg_color">
                    <h4 class="card-title">Add Upazila Form</h4>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-content collpase show">
                                <div class="card-body">
<form action="admin/store_upazila" enctype="multipart/form-data" method="post" class="form form-horizontal striped-rows">
    <div class="form-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                <input type="text" id="eventRegInput1" class="form-control" placeholder="i.e www.upazila.com (optional)" name="url">
            </div>
        </div>
        <div class="form-group row">
