...
<div class="card-body">
<form action="admin/update_career_post/<?=$abouts_us_data[0]['id'];?> enctype="multipart/form-data" method="post" class="form form-horizontal striped-rows"  autocomplete="off" >
<div class="form-body">
