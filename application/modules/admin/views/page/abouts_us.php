...
<div class="card-body">
<form action="admin/update_abouts_us_post/<?=$abouts_us_data[0]['id'];?> enctype="multipart/form-data" method="post" class="form form-horizontal striped-rows"  autocomplete="off" >
<div class="form-body">
<div class="form-group row">
    <label class="col-md-3 label-control" for="eventRegInput1">Descriptions</label>
    <div class="col-md-8">
         <textarea name="abouts_us" class="span3 " id="editor"  required>
         <?=$abouts_us_data[0]['abouts_us'];?>
         </textarea>
    </div>
</div>
</div>
