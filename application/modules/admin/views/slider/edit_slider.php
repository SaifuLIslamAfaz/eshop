...
<body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
            ...
            <div class="col-10 offset-1">
              <div class="card">
                <div class="card-header bg_color">
                  <h4 class="card-title">Update Slider Form</h4>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-content collpase show">
                        <div class="card-body">
                          <form action="admin/update_slider_post/<?= $slider_data[0]['id']; ?>" enctype="multipart/form-data" method="post" class="form form-horizontal striped-rows">

                            <div class="form-group row">
                              <label class="col-md-3 label-control" for="eventRegInput1">Slider Title</label>
                              <div class="col-md-8">
                                <input type="text" id="eventRegInput1" class="form-control" placeholder="Slider title" name="slider_title" value="<?= $slider_data[0]['slider_title']; ?>">
                              </div>
                            </div>
                            <div class="form-body">
                              <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                  <input type="text" id="eventRegInput1" class="form-control" placeholder="Slider Name" name="slider_head" value="<?= $slider_data[0]['slider_name']; ?>">
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                <input type="hidden" name="pre_img" value="<?= $slider_data[0]['slider_image']; ?>">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                  ...
                                  <div>
                                    <span class="btn btn_select_img btn-file mt-1">
                                      ...
                                      <input type="file" name="files" value="<?= $slider_data[0]['slider_image']; ?>">
                                    </span>
  ...
  <script>
    var show_status = "<?= $slider_data[0]['show_status'] ?>";
