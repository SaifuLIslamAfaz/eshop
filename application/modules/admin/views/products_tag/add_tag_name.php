        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg_color" >
                    <h4 class="card-title" >Add Tag Form</h4>
		...
		<div class="col-md-10">
	        <div class="card">
	            ...
	            <div class="card-content collpase show">
	                <div class="card-body">
						<form  action="admin/add_tag_post"  enctype="multipart/form-data" method="post" class="form form-horizontal striped-rows">
							<div class="form-body">
	                			<div class="form-group row">
	                            	<label class="col-md-3 label-control" for="eventRegInput1">Tag-Name</label>
	                            	<div class="col-md-9">
	                            		<input type="text" id="eventRegInput1" class="form-control" placeholder="tag name" name="tag_name">
	                            	</div>
		                        </div>
