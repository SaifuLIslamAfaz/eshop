        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg_color" >
                    <h4 class="card-title" > Upadate Menu Settings Form</h4>
		...
		<div class="col-md-10">
	        <div class="card">
	            ...
	            <div class="card-content collpase show">
	                <div class="card-body">
						<form  action="admin/update_menusettings_post/<?=$menu_data[0]['menu_id'];?>" enctype="multipart/form-data" method="post" class="form form-horizontal striped-rows">
							<div class="form-body">
	                			<div class="form-group row">
	                            	<label class="col-md-3 label-control" for="eventRegInput1">Menu-Name</label>
	                            	<div class="col-md-9">
	                            		<input type="text" id="eventRegInput1" class="form-control" placeholder="menu name" name="menu_name" value="<?=$menu_data[0]['menu_name'];?>" autocomplete="0">
	                            	</div>
		                        </div>
                                <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="eventRegInput1">Menu-Link</label>
	                            	<div class="col-md-9">
	                            		<input type="text" id="eventRegInput1" class="form-control" placeholder="enter menu link" name="menu_link" value="<?=$menu_data[0]['menu_link'];?>">
	                            	</div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <option value="">Select</option>
                                      ...
                                      <?php foreach ($all_menu_list as $key => $row) { ?>

                                            <option 
                                            <?php 
                                            if($row['id']==$menu_data[0] ['menu_positions']){echo "selected";}?> 
