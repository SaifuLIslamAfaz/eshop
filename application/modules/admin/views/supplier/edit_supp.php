...
<div class="card-body">
<form action="admin/update_su_post/<?=$supp_list[0]['sup_id'];?>" enctype="multipart/form-data" method="post" class="form form-horizontal striped-rows">
  <div class="form-body">
    <div class="form-group row">
      <label class="col-md-4 label-control" for="eventRegInput1">Supplier Name</label>
      <div class="col-md-8">
        <input type="text" id="eventRegInput1" class="form-control" placeholder="supplier name" name="supplier_name" value="<?=$supp_list[0]['sup_name'];?>">
      </div>
    </div>
    <div class="form-group row">
      <label class="col-md-4 label-control" for="eventRegInput1">Supplier Phone</label>
      <div class="col-md-8">
        <input type="phone" id="eventRegInput1" class="form-control" placeholder="supplier name" name="supplier_phone_no" value="<?=$supp_list[0]['sup_phone_no'];?>">
      </div>
    </div>
    <div class="form-group row">
